 ...
 * G G      → Gantt
 */
export const useKeyboardShortcuts = ({ onPaletteOpen, onNewTask }: ShortcutOptions) => {
    ...
    const handler = (e: KeyboardEvent) => {
      ...
      if (pendingG.current) {
        ...
        switch (e.key.toLowerCase()) {
          ...
          case 'p': e.preventDefault(); navigate('/projects'); return;
          case 'k': e.preventDefault(); navigate('/kanban'); return;
          case 'g': e.preventDefault(); navigate('/gantt'); return;
        }
